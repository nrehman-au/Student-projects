...
**Methods and code.** Start with [multinomial logistic regression](https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.LogisticRegression.html) to rank the known candidate configurations using vibration and operational features. If raw spectra or time series are available, compare it with [MiniRocket](https://arxiv.org/abs/2012.08791), for which [open-source code](https://github.com/angus924/minirocket) is available. Vibration signatures are strongly influenced by component kinematics and structural characteristics, suggesting that machine configuration information may already be encoded within measured signals.
