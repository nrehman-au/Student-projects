...
All three projects are intended primarily for Master students. Each can be reduced to Bachelor level when the partner supplies a prepared dataset and a fixed task. The Bachelor version focuses on implementing and comparing established methods; the Master version adds a new representation, feature design or evaluation question.
:::
...
## 1.2  Siemens Gamesa: Inferring drivetrain configuration and kinematics from vibration signals {#project-1-2}
