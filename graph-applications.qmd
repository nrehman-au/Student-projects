...
*Core experiment.* Compare the three methods, then vary LightGCN depth or its training negative sampler and plot the accuracy/coverage trade-off.
:::

**Practical notes.** This is a compact BSc project with limited MSc novelty. Avoid future-interaction leakage and sampled-negative evaluation.
